...
if __name__=='__main__': 
    ...
    img1 = cv2.imread("https://d1hjkbq40fs2x4.cloudfront.net/2020-01-09/files/canon-landscape-photography-preparation-tips_1968-1s.jpg") 
 
    # Input image containing all the different shapes 
    img2 = cv2.imread("https://d1hjkbq40fs2x4.cloudfront.net/2020-01-09/files/canon-landscape-photography-preparation-tips_1968-1s.jpg") 
